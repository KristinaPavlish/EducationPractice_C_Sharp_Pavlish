...
public class CollectionService : ICollectionService
{
    ...
    public void EditObjectById<T>(MyCollection<T> myCollection, string id, string property, string value)
    {
        ...
        foreach (var field in fields)
        {
            if (field.FieldType == typeof(Guid))
            {
                ...
                PropertyInfo fieldInfoState = t.GetProperty("State");
                ...
                foreach (var prop in props)
                {
                    ...
                    if (prop.Name == "State")
                    {
                        fieldInfoState.SetValue(newClass, State.Draft);
    ...
    public void ToPublished<T>(MyCollection<T> myCollection, string id)
    {
        Type objectType = typeof(T);
        FieldInfo[] fields = objectType.GetFields(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
        foreach (var field in fields)
        {
            if (field.FieldType == typeof(Guid))
            {
                ...
                foreach (var prop in props)
                {
                    if (prop.Name == "State")
                    {
                        fieldInfoState.SetValue(newClass, State.Published);
    ...
    public void ToModeration<T>(MyCollection<T> myCollection, string id)
    {
        Type objectType = typeof(T);
        FieldInfo[] fields = objectType.GetFields(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
        foreach (var field in fields)
        {
            if (field.FieldType == typeof(Guid))
            {
                ...
                foreach (var prop in props)
                {
                    if (prop.Name == "State")
                    {
                        fieldInfoState.SetValue(newClass, State.Moderation);
