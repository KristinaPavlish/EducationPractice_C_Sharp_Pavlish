...
public class Auth
{
    ...
    private string usersFilePath = "E:\\EducationPractice_C_Sharp_Pavlish\\EducationalPractice\\EducationalPractice.Task_4.ConsoleApp\\users.txt"; // шлях до файлу для збереження даних про користувачів
    private string adminssFilePath = "E:\\EducationPractice_C_Sharp_Pavlish\\EducationalPractice\\EducationalPractice.Task_4.ConsoleApp\\Admins.txt"; // шлях до файлу для збереження даних про адмінів
